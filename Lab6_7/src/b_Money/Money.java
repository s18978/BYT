...
public class Money implements Comparable {
	...
	/** Return the amount of money. @return Amount of money in Double type. */

	public Integer getAmount() {
		return amount;
	}
	
	/** Returns the currency of this Money. @return Currency object representing the currency of this Money */

	public Currency getCurrency() {
		return currency;
	}
	
	/** Returns amount of money in the string form "(amount) (currencyname)", e.g. "10.5 SEK".
	 * we represent decimal numbers with integers - the "10.5 SEK" is represented as integer 1050
	...
	/** Gets the universal value of Money, according the rate of its Currency.
	...
	/** Check to see if value of this money is equal to value of another Money of some other Currency.
